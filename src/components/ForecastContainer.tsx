...
export const ForecastContainer = ({ forecastData}: {forecastData: any}) => {
  ...
  return (
    <div id="forecastContainer" className={`${forecastData.current.is_day === 0 ? 'bg-slate-800 text-white' : 'bg-sky-300 text-black'} relative overflow-auto flex items-start justify-center w-4/5 sm:w-full p-2 font-bold rounded-lg shadow-md shadow-red-800`}>
