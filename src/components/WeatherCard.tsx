...
export const WeatherCard = ({ currentDataInfo }: { currentDataInfo: any }) => {
  return (
    <div className={`${currentDataInfo.current.is_day === 0 ? 'bg-slate-800 text-white' : `text-black ${currentDataInfo.current.cloud > 50 ? 'cloudyDay' : 'day'}`} relative flex items-center justify-center w-4/5 font-bold rounded-lg shadow-md shadow-red-800`}>
